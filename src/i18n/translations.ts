    ...
    list: [
      {
        ...
        bullets: [
          "Construo e mantenho aplicações web e mobile usando TypeScript, React e Tailwind CSS",
          "Contribuo com o Habilita+, plataforma para a jornada de obtenção da CNH",
          "Desenvolvo features full stack abrangendo frontend, backend e integrações",
          "Integro APIs externas, incluindo soluções de pagamento como Stripe",
          "Investigo e resolvo problemas técnicos para melhorar a estabilidade da aplicação e a evolução do produto",
          "Apoio rotinas de deploy, manutenção de ambientes e melhoria de fluxos",
          "Utilizo ferramentas de desenvolvimento assistido por IA (Lovable, Antigravity) para acelerar a entrega",
          "Participo de code reviews e promovo boas práticas de engenharia",
        ],
      },
      {
        id: "strides",
        ...
        period: "2023 — 2025",
        bullets: [
          "Apoiei a configuração e gestão de mais de 40 turmas educacionais e fluxos de certificados",
